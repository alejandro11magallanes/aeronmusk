              ...
              <div class="bg-white shadow-md rounded my-6 p-5">
                <form method="POST" action="{{ route('admin.marcas.store') }}" enctype="multipart/form-data">
                  ...
                  <div class="flex flex-col space-y-2">
                    ...
                    <input id="title" type="text" name="nombre" value="{{ old('nombre') }}" required
                ...
                <div class="flex flex-col space-y-2">
                    ...
                    <input id="title"type="text"  name="descripcion" required value="{{ old('descripcion') }}"
                ...
                <div class="text-center mt-16 mb-16">
                  <button type="submit" class="bg-blue-500 text-white font-bold px-5 py-1 rounded focus:outline-none shadow hover:bg-blue-500 transition-colors ">Crear Marca</button>
                </div>
              </div>
