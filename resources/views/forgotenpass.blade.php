...
<div class="container" id="container">
    ...
    <input type="email" name="correo" id="email" class="border-2 rounded px-3 py-2 w-full focus:outline-none focus:border-blue-400 focus:shadow" placeholder="Correo electronico" :value="old('email')" required autofocus />
